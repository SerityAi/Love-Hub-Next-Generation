...
function library:AddWindow(text,keybind)
    ...
    NameHub.Position = UDim2.new(0, 40, 0, 0)
    ...
    local ImageHub = Instance.new("ImageLabel")
    ImageHub.Name = "ImageHub"
    ImageHub.Parent = Top
    ImageHub.BackgroundTransparency = 1.000
    ImageHub.Position = UDim2.new(0, 10, 0, 0)
    ImageHub.Rotation = 0
    ImageHub.Size = UDim2.new(0, 25, 0, 25)
    ImageHub.Image = 'http://www.roblox.com/asset/?id=17170148384'
    ImageHub.ImageTransparency = 0
    ...
    BindButton.Text = "[ "..string.gsub(tostring("Blox Fruit Kaitun"),"Enum.KeyCode.","").." ]"
    ...
    function Ui:AddTab(text)
        ...
        function uitab:AddPage()
            ...
            function main:AddDropdown(text,option,callback)
                ...
                Dropdownn.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
                ...
                DropBtn.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
            ...
            function main:AddSlider(text,min,max,set,callback)
                ...
                sliderr.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
            ...
            function main:AddTextbox(text,disappear,callback)
                ...
                Textboxx.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
            ...
            function main:AddToggle(text,config,callback)
                ...
                Tgle.Name = "Tgle"
                Tgle.Parent = Toggle
                Tgle.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
...
local GeneralTab = Windows:AddTab("General")
local GeneralLeft = GeneralTab:AddPage()
local GeneralRight = GeneralTab:AddPage()

------------------------------- [ General Left ] -------------------------------

GeneralLeft:AddSeperator("Main Function")

GeneralLeft:AddToggle("Auto Farm Kaitun", true, function(Value)
...
GeneralLeft:AddToggle("FPS Booster", true, function(Value)
    getgenv().Setting['FPS Booster'] = Value
end)

GeneralLeft:AddToggle("White Screen", true, function(Value)
    getgenv().Setting['White Screen'] = Value
end)

GeneralLeft:AddToggle("Rejoin", false, function(Value)
    getgenv().Setting['Rejoin'] = Value
end)
------------------------------- [ Function ] -------------------------------
